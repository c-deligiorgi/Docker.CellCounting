...
class CellsDataset(Dataset):
    ...
    def __init__(self, root_dir, transform=None, return_filenames=False):
        ...
        self.files = [os.path.join(self.root, filename)
    ...
    def duplicate_and_transform(self, transforms):
        ...
        for pind in range(0, currfilelen-1):
            ...
            # path[:-4] is the path without the .png extension.
            newpath = path[:-4]+'trans.png'
            ...
            # strip away the directory list and just get the filename
